...
// Start the server
app.get("/", (req, res) => {
  res.send("Hello From Arya's Food API... To, access the Database of the api manually type... /api/foods at the end of this page's URL ... To Perform CRUD operations i used : Curl Method ::: Thank You!!!");
});
